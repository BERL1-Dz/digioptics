    ...
    <div class="modal fade" id="modalCenter" tabindex="-1" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          ...
          <form class="" action="{{ url('create_fournisseur') }}" method="post" enctype="multipart/form-data">
            @csrf
                        ...
                        <td>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" style="">
                                    ...
                                    <a class="dropdown-item" href="fournisseurEdit/{{ $fournisseur['id'] }}"><i class="bx bx-edit-alt me-1"></i> Edit</a>
