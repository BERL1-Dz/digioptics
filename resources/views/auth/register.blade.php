        ...
        <div class="authentication-inner">
          ...
          <div class="card">
            <div class="card-body">
              ...
              @csrf
                <div class="mb-3">
                  <label for="name" class="form-label" :value="__('Name')">Nom d'utilisateur</label>
                  <input
                    type="text"
                    class="form-control"
                    id="name"
                ...
                <!-- confirme password-->
                <div class="mb-3 form-password-toggle">
                  <label class="form-label" for="password_confirmation" :value="__('Confirm Password')">Confirmation mot de passe</label>
                  <div class="input-group input-group-merge">
                    <input
                      type="password"
                ...
                <div class="mb-3">
                  <div class="form-check">
                    ...
                    <label class="form-check-label" for="terms-conditions">
                      J'accepte
                      <a href="javascript:void(0);">Les termes et les conditions d'utilisation de l'application</a>
                    </label>
                  </div>
                </div>
