<form action="{{ isset($recette) ? route('recette.update', $recette) : route('recette.store') }}" method="POST">
    @csrf
    @if(isset($recette))
    @method('PUT')
    @endif
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="client_nom" name="client_nom" value="{{ $recette->client_nom ?? old('client_nom') }}" required>
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
                <label for="client_prenom">Prénom du Client</label>
                <input type="text" class="form-control" id="client_prenom" name="client_prenom" value="{{ $recette->client_prenom ?? old('client_prenom') }}" required>
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
                <label for="client_telephone">Téléphone</label>
                <input type="text" class="form-control" id="client_telephone" name="client_telephone" value="{{ $recette->client_telephone ?? old('client_telephone') }}" required>
            </div>
        </div>
    </div>
    ...
    <div class="row mt-4">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <select class="form-control" id="monture_id" name="monture_id" required>
    ...
    <div class="row mt-4">
        <div class="col-12">
            <div class="form-group">
                ...
                <textarea class="form-control" id="notes" name="notes" rows="3">{{ $recette->notes ?? old('notes') }}</textarea>
            </div>
        </div>
    </div>
