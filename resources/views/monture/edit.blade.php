    ...
    <div class="container-xxl flex-grow-1 container-p-y" role="document">
        <div class="modal-content card">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel4">Modifier Monture</h5>
                <a href="/monture"><button type="button" class="btn" data-bs-dismiss="modal" aria-label="Retour"><i
                            class='bx bx-left-arrow-alt'></i></button></a>
            </div>
            <form action="{{ url('monture/update/' . $data->id) }}" method="post" enctype="multipart/form-data">
                @method('PUT')
                @csrf
                <div class="modal-body" id="myform">
                    ...
                    <div class="row">
                        <div class="col mt-1">
                            ...
                            <input type="text" id="emailWithTitle" class="form-control" placeholder="048700"
                                name="code_monture" value="{{ $data['code_monture'] }}" />
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col mt-1">
                            ...
                            <input type="text" id="emailWithTitle" class="form-control" placeholder="ARMANI" required
                                name="marque_monture" value="{{ $data['code_monture'] }}" />
                        </div>
                    ...
                    <div class="row mt-1 g-2">
                        <div class="col mt-1">
                            ...
                            <input type="text" id="emailWithTitle" class="form-control" placeholder="Organique" required
                                name="matiere_monture" value="{{ $data['matiere_monture'] }}" />
                        </div>
                        <div class="col mt-1">
                            ...
                            <input type="number" id="dobWithTitle" class="form-control" placeholder="60 Ø" required
                                name="taille_monture" value="{{ $data['taille_monture'] }}" />
                        </div>
                    </div>
                    <div class="row mt-1 g-2">
                        <div class="col mt-1">
                            ...
                            <input type="text" id="emailWithTitle" class="form-control" placeholder="AR 101M" required
                                name="model_monture" value="{{ $data['model_monture'] }}" />
                        </div>
                        <div class="col mt-1">
                        ...
                        <div class="col mt-1">
                            ...
                            <input type="text" id="dobWithTitle" class="form-control" placeholder="BLACK"
                                name="coloris_libellé" value="{{ $data['coloris_libellé'] }}" />
                        </div>
                    </div>
                    ...
                    <div class="row mt-1 g-2">
                        <div class="col mt-1">
                            ...
                            <input type="text" id="emailWithTitle" class="form-control" placeholder="Traditionnel"
                                required name="style_monture" value="{{ $data['style_monture'] }}" />
                        </div>
                    </div>
                    ...
                    <div class="row mt-1 g-2">
                        <div class="col mt-1">
                            ...
                            <input type="text" id="emailWithTitle" class="form-control" placeholder="Solaire"
                                required name="type_monture" value="{{ $data['type_monture'] }}" />
                        </div>
                    </div>
                    ...
                    <div class="row mt-1 g-2">
                        <div class="col mt-1">
                            ...
                            <input type="text" id="emailWithTitle" class="form-control" placeholder="HOMME" required
                                name="genre_monture" value="{{ $data['genre_monture'] }}" />
                        </div>
                    </div>
                    ...
                    <div class="row mt-1 g-2">
                        <div class="col mt-1">
                            ...
                            <input type="number" id="dobWithTitle" class="form-control" placeholder="Pa_Verre" required
                                name="pa_monture" value="{{ $data['pa_monture'] }}" />
                        </div>
                        <div class="col mt-1">
                            ...
                            <input type="number" id="dobWithTitle" class="form-control" placeholder="Pv_Verre" required
                                name="pv_monture" value="{{ $data['pv_monture'] }}" />
                        </div>
                    </div>
                </div>
