            ...
            <div class="modal-body" id="myform">
              ...
              <div class="row mt-1 g-2">
                  ...
                  <div class="col mt-1">
                      ...
                      <input type="text"
                       ...
                       class="form-control"
                       placeholder="BLACK"
                       name="coloris_libellé"
                        value="{{$data['coloris_libellé']}}"
                       />
                  </div>
              </div>
                  ...
                  <div class="col mt-1">
                      ...
                      <input type="text"
                       id="emailWithTitle"
                        ...
                        required name="style_monture"
                        value="{{$data['style_monture']}}"
                           />
                  </div>
              </div>
              ...
              <div class="row mt-1 g-2">
                  <div class="col mt-1">
                      ...
                      class="form-control"
                      placeholder="Solaire"
                      required name="type_monture"
                      value="{{$data['type_monture']}}"
                      />
                  </div>
              </div>
                  ...
                  <div class="col mt-1">
                      ...
                      <input type="text"
                       id="emailWithTitle"
                        class="form-control"
                        placeholder="HOMME"
                        required name="genre_monture"
                        value="{{$data['genre_monture']}}"
                        />
                  </div>
              </div>
